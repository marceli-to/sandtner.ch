<template>
  <button :type="type" :class="classes" :disabled="disabled">
    <template v-if="submitting">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-12 h-12 mr-10 relative translate-y-5">
...
const props = defineProps({
  ...
  classes: {
    type: String,
    default: 'flex justify-between font-bold uppercase tracking-wider border border-tangerine text-tangerine px-15 py-5 hover:border-tangerine hover:text-white hover:bg-tangerine transition-all'
  },
  disabled: {
    type: Boolean,
    default: false
